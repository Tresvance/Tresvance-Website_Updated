...
const Home = () => {
  ...
  return (
    <div className="w-full bg-[#070707] text-white font-sans m-0 p-0 overflow-x-hidden">
      <main className="w-full pt-[80px] md:pt-[80px] bg-[#070707] m-0 p-0">
        ...
        <section className="py-20 bg-[#070707] text-white px-6 sm:px-10 md:px-16 lg:px-20 animate-fade-in">
          <div className="overflow-hidden w-full mb-12">
            <h2 className="text-5xl md:text-6xl font-machina flex items-center justify-center relative">
              <div className="marquee-wrapper w-full">
                <div className="marquee flex space-x-8 text-white tracking-widest">
                  ‎ INNOVATE‎
  ...
  <motion.div
        ...
        {/* ── STATS SECTION ── */}
        <section className="py-12 sm:py-16 bg-[#070707] text-white px-4 items-center justify-center md:ml-[90px] sm:px-8 overflow-x-hidden">
          <motion.div
          ...
          >
            ...
            >
              ...
              <motion.div
                ...
                whileHover={{ scale: 1.1 }}
                className="absolute right-3 top-0 bg-purple-200 rounded-full w-40 sm:w-48 md:w-64 h-40 sm:h-48 md:h-64 flex flex-col items-center justify-center text-center z-10 shadow-md text-black"
              >
              ...
              <motion.div
                ...
                whileHover={{ scale: 1.1 }}
                className="absolute bottom-[10px] left-1/3 bg-[#1a1a1a] border border-gray-700 rounded-full w-28 sm:w-32 md:w-36 h-28 sm:h-32 md:h-36 flex flex-col items-center justify-center text-white text-center z-30 shadow-lg"
              >
